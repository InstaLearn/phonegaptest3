...
$string['proxy_port_from'] = 'Pierwszy numer portu użyteczny dla proxy';
$string['proxy_port_to'] = 'Ostatni numer portu użyteczny dla proxy';
$string['proxy_port_from_description'] = 'Proxy jest używane do łączenia klientów z jail. Firewall serwera musi pozwalać na ten zakres portów';
