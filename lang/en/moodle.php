...
<body>
<p><span style="font-family:arial,helvetica,sans-serif;">Hi {$a->firstname},</span></p>

<p><a href="http://instalearn.co.in" target="_blank"><img alt="" src="http://instalearn.co.in/images/mail/head.jpg" style="width: 800px; height: 538px;" /></a></p>

<p><br />
<span style="font-family:arial,helvetica,sans-serif;">Your current login information is now:<br />
&nbsp;&nbsp; username: {$a->username}<br />
&nbsp;&nbsp; password: {$a->newpassword}<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (you will have to change your password<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; when you login for the first time)</span></p>

<p><span style="font-family:arial,helvetica,sans-serif;"><span style="background-color:#FFFFFF;">To start usng \&#39;{$a-&gt;sitename}\&#39;, login at</span><br />
<span style="background-color:#FFFFFF;">&nbsp;&nbsp; {$a->link}</span></span></p>
 
<p><a href="instalearn.co.in" target="_blank"><img alt="" src="http://instalearn.co.in/images/mail/middle.jpg" style="width: 796px; height: 711px;" /></a></p>

<p><img alt="" src="http://instalearn.co.in/images/mail/bottom.jpg" style="width: 800px; height: 206px;" /></p>
...
$string['emailresetconfirmation'] = '<html><body>Hi {$a->firstname},
...
<head>
    ...
    margin: auto;
">
<table width="740px" border="0px" align="center" bgcolor="#f0f0f0" style="padding:20px;font-family:segoe ui">
<tbody>
...
<!-- header image  -->
<td align="center"> 
<a href="http://www.instalearn.co.in?utm_source=sales&utm_medium=email&utm_campaign=rmo&utm_term=vc&utm_content=content1" target="_blank"> 
<img src="http://instalearn.co.in/images/logo-final.png" width="150px" style="padding-left:20px;"></a>
</td>
</tr>
...
<td  width="100%" align="center">
	<h1 style="font-size: 22px; padding-top:10px; color: #272727;">One Stop Place for your Engineering Academics</h1>
...
<td>
	<p align="justify" style="font-size: 16px;font-family: segoe UI,Arial, sans-serif; padding-left: 10px;"><br/>Dear Student,<br/><br/>
	Hope you enjoyed the presentation by Vinay and Charles at your orientation program on last Saturday.<br/><br/>
	InstaLearn is a centralized online platform to find all the course material and updates for Engineering colleges. It is highly aimed at involving students in regular course activity with advanced learning management tools and interactive learning material.<br/>
	<br/>You can now enjoy full access to our portal for free  for 1 month.<br/><br/>
	<b>Username:</b> {$a->username}<br/>
	<b>Password:</b> {$a->newpassword} <i>(You will need to change your password on your first login)</i><br/>
	<b>Link to login:</b> <a href="http://ilearn.instalearn.co.in" target="_blank">ilearn.instalearn.co.in</a>
	</p>
...
<tr style="height:100px;font-size:20px">
        <td>
        	<br>
			<div style="color: #272727; font-size: 20px; font-weight: bold; margin-bottom: 10px; padding: 10px; padding-left: 130px; ">
                Fill the form below in case of queries
            </div>			
			<form action="http://www.v2vsolutions.com/instalearn/send_mail_ilearn.php" method="post" target="_blank">
                <table align="center" border="0" cellpadding="3" style="margin:0 auto;font-size:15px" width="80%">
                    <tbody>
                        <tr>
                            <td>Name:</td>

                            <td><input maxlength="20" name="name" size="40" style="padding:5px;border:1px solid grey;border-radius:2px" type="text" required=""></td>
                        </tr>

                        <tr>
                            <td>Email id:</td>

                            <td><input maxlength="30" name="email" size="40" style="padding:5px;border:1px solid grey;border-radius:2px" type="email" required=""></td>
                        </tr>

                        <tr>
                            <td>Phone Number:</td>

                            <td><input maxlength="14" name="phone" size="40" style="padding:5px;border:1px solid grey;border-radius:2px" type="text" required=""></td>
                        </tr>
						
                        <tr>
                            <td>College:</td>

                            <td><input maxlength="14" name="school" size="40" style="padding:5px;border:1px solid grey;border-radius:2px" type="text" required=""></td>
                        </tr>					                    
                        <tr>
                            <td></td>
								<input type="hidden" name="source" value="">
								<input type="hidden" name="emailsubject" value="InstaLearn query from login">
							<td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="left"><input name="Submit" style="font-weight:bold;letter-spacing:-0.5px;line-height:100%;text-align:center;text-decoration:initial;color:#FFF;font-family:Arial;font-size:18px;padding:8px 13px;background-color:#20B2A5;border-radius:2px;border:0" type="submit" value="Submit"></td>
                        </tr>
						
                    </tbody>
                </table>
            </form>
			<p align="justify" style="font-size: 16px;font-family: segoe UI,Arial, sans-serif; padding-left: 10px;">Cheers,<br/>InstaLearn Team<br/>www.instalearn.co.in</p>
            <br/>			
        </td>
    </tr>
...
<tr>
<td>
<p style="color:grey;font-size:10px;margin:10px 10px 10px 10px;text-align:center">This email is produced and distributed by <a href="http://ilearn.instalearn.co.in/?utm_source=login&utm_medium=email&utm_campaign=hyd&utm_term=vc&utm_content=content1" target="_blank">InstaLearn</a> All rights reserved.</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
<p style="color:grey;font-size:10px;margin:10px 10px 10px 10px;text-align:center">This email is produced and distributed by <a href="http://instalearn.co.in/?utm_source=login&utm_medium=email&utm_campaign=hyd&utm_term=vc&utm_content=content1" target="_blank">InstaLearn</a> All rights reserved.</p>
</td>
</tr>
</tbody>
</table>
